<div class="page-title  home text-center">
    <span class="heading-page"> Bienvenue sur ma page</span>
    <p class="mt20">cette page est fait pour vous presenter mes competences</p>
</div>
<section class="hexagon-menu clear">
    <!--Welcome-->
    <aside class="hexagon-item">
        <div class="hex-item">
            <div></div>
            <div></div>
            <div></div>
    ...
    <aside class="hexagon-item">
        ...
        <a href="/cv" class="hex-content">
           <span class="hex-content-inner">
               <span class="icon">
                   <i class="fa fa-id-badge"></i>
               </span>
               <span class="title">C.V</span>
           </span>
            <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1"
                 xmlns="http://www.w3.org/2000/svg">
                <path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z"
    ...
    <aside class="hexagon-item">
        ...
        <a href="/portfolio" class="hex-content">
            <span class="hex-content-inner">
                <span class="icon">
